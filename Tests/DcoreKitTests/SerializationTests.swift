...
final class SerializationTests: XCTestCase {
    func testGetAccountHistoryJsonSerialization() {
        ...
        """
        let result = try? GetAccountHistory(accountId: "1.2.3".core.chainObject!).toJson()
    ...
    func testGetRelativeAccountHistoryJsonSerialization() {
        ...
        """
        let result = try? GetRelativeAccountHistory(accountId: "1.2.3".core.chainObject!).toJson()
        XCTAssertEqual(result, api)
    }
    ...
    func testTransferOperationJsonSerialization() {
        ...
        let op = TransferOperation(from: "1.2.3".core.chainObject!, to: "1.2.3".core.chainObject!, amount: AssetAmount(with: "895438905348905349949490330940943"))
        print(try! op.toJson())
    ...
    func testTransferOperationDataSerialization() {
        ...
        let kp = "5Jd7zdvxXYNdUfnEXt5XokrE3zwJSs734yQ36a1YaqioRTGGLtn".core.keyPair!
        let recipient = "DCT6bVmimtYSvWQtwdrkVVQGHkVsTJZVKtBiUqf4YmJnrJPnk89QP".core.address!
        let memo = Memo("hello memo", keyPair: kp, recipient: recipient, nonce: BigInt(132456789))
        let op = TransferOperation(from: "1.2.30".core.chainObject!, to: "1.2.31".core.chainObject!, amount: AssetAmount(10000000), memo: memo, fee: AssetAmount(5000))
